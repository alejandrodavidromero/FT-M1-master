...
function nFactorial(n) {
  if (n < 0) return "factorial de un numero negativo no existe, (n) debe ser un numero positivo";
  if (n === 0) return 1;
  if (n !== (Math.floor(n))) return "Los numeros decimales no tienen factorial";
  if (n > 0) {
