...
//let prueba = cacheFunction;
//const squareCache;
/*
Ejercicio 2

Tu tarea aquí es lograr, mediante un closure, que cacheFunction actúe como una memoria caché
 para el callback que recibe por parámetro1 (cb); es decir, que "recuerde" el resultado
...
cacheFunction debe retornar una función. Esta función debe aceptar un argumento (arg)
 ...
 de la invocación(tip: usá un objeto donde cada propiedad sea el argumento,
   y su valor el resultado de la correspondiente invocación a cb) de manera que, la próxima vez
